...
Standalone script as required by spec (§3 data/synthetic_weather.py).
"""
...
OUTPUT_PATH = Path(__file__).parent / "synthetic_weather.csv"
...
def generate():
    ...
    for zone in ZONES:
        ...
        for i in range(days):
            ...
            max_rainfall = np.random.uniform(8.0, 35.0) if has_heavy_rain else np.random.uniform(0.0, 7.5)
